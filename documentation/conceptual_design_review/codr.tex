...
\noindent
 {Progress Review 1}: The goal for Progress Review 1 is to have all hardware design complete with parts on order. \\
 {Progress Review 2}: The goal for Progress Review 2 is to have an assembled frame/chassis, a full ROS simulation environment, and a completed GPS + RTK base station\\
...
\hline 
 {Too Few Features for Perception:} 
...
Technical\\
 ...
 {Team Falling Behind Due to Work:} 
...
&
Schedule\\
 {Localization Poor for Following Edges:} 
...
Technical\\
 ...
 {Poor Weather for Validation Experiments:} 
...
Schedule\\
 ...
 {Team Member Has Family Constraints:} 
...
Technical\\
 ...
 {Subsystem Harder Than Expected:} 
